            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <div className="">
                  ...
                  përdorur gjerësisht nga profesionistë në të gjithë botën.
                  Programimi i ndihmon fëmijët të rrisin përqendrimin dhe të
                  përmirësojnë përformancën akademike. Kodimi i mëson atyre që
                  ta copëzojnë një problem në pjesë më të vogla dhe të punojnë
                  me secilën prej pjesëve për ta zgjidhur atë. Ai zhvillon të
                  menduarin kritik.
                </div>
              </div>
              <div>
                Prindërit e fëmijëve që mësojnë kodimin shprehen se vënë re
                përmirësim të ndjeshëm në arritjet akademike të fëmijës, sidomos
                në shkencat ekzakte.
              </div>
              <div className="font-medium text-gray-800">
                Për tu regjistruar fëmija duhet:
          ...
          <div className="relative bg-white rounded-xl p-4 shadow-lg border-2 border-gray-100 col-span-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                benefitesh për fëmijët. Ata zhvillojnë aftësi që janë të
                nevojshme gjatë githë jetës si psh:
              </div>
              <div>
                <ul>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>Bashkëpinimin dhe punën në grup</span>
                  </li>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>Të folurin në public dhe prezantimin</span>
                  </li>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>Të mbledhin dhe të analizojnë të dhëna</span>
                  </li>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>
                      Si të përdorin median sociale si mjet dobi-prurës
                    </span>
                  </li>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>Si të zgjidhin probleme reale dhe komplekse</span>
                  </li>
                  <li className="flex flex-row items-center gap-2">
                    <CgRadioChecked className="text-rose-500" />
                    <span>
                      Si të përdorin kuriozitetin dhe kreativitetin për tu
                      përballur me situata të vështira
                    </span>
                  </li>
                </ul>
              </div>
